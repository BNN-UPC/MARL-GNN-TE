...
class DatanetAPI:
    ...
    def __init__ (self, data_folder, intensity_values = [], shuffle=False, topology=None):
        """
...
#        User introduced single intensity
    ...
    def __iter__(self):
        ...
        graphs_dic = {}
        routings_dic = {}
        dirss = os.walk(self.data_folder)
        ...
        if self.shuffle:
            ...
            numpy.random.shuffle(tuple_files)
                ...
                try:
                    ...
                    while(True):
                        ...
                        if self.topology is not None:
                            if g.number_of_nodes() != topology_nodes[self.topology] or g.number_of_edges() != topology_edges[self.topology]:
                                continue
